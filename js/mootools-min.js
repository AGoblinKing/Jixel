...
web build:
 - http://mootools.net/core/be4b991f287f7f8665bfb8b7a63dbedf

packager build:
 - packager build Core/Class Core/JSON
...
for(var i in h){f.call(this,i,h[i],true);}},this);}};}).call(this);if(typeof JSON=="undefined"){this.JSON={};}(function(){var special={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};
